    ...
    def sarsa(self,
        ...
        for episode_n in range(n_episodes):
            ...
            while not (terminal or truncated):
                ...
                # Update q
                self.__q[obs, action] += alpha * (reward + gamma * self.__q[new_obs, new_action] - self.__q[obs, action])
    ...
    def q_learning(self,
        ...
        for episode_n in range(n_episodes):
            ...
            while not (terminal or truncated):
                ...
                self.__q[obs, action] += alpha * (reward + gamma * max_q_value - self.__q[obs, action])
